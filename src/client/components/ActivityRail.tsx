import { Bot, Check, CircleEllipsis, GitPullRequest, ListFilter, Terminal, UserRound } from "lucide-react";
            ...
            >
              ...
              <span className="activity-content">
                <span className="activity-title">
                  {display.title}
                  {display.type === "prompt" && display.delivery === "queue" ? <em>Queued</em> : null}
                </span>
              ...
              {display.type === "tool" && display.status === "completed" ? <Check className="activity-check" size={14} /> : null}
            </button>
          );
        })}
      </div>
